...
type Configuration struct {
	...
	// An array of store providers (i.e. k/v stores)
	Stores *[]*map[string]string `json:"store"`
	// An array of discovery providers for services
	Discovery []*map[string]string `json:"discovery"`
	// An array of templates
	Template []*HookTemplate `json:"template"`
}
